...
public class SMS implements SMSManager {
    ...
    public SMS(String SENDER,
               String MESSAGE,
               String RECIPIENT,//String TRANSACTION_ID,
   ...
   // public String getTRANSACTION_ID() { return TRANSACTION_ID; }
    ...
    //  Implementing Functions from SMS Manager Interface
    // 1. Insert SMS
    @Override
    public void insertSMS() {
        String insertQuery = "INSERT INTO tbl_sms (sender, message, recipient, transactionID, timestamp, status) " +
                "VALUES ('" +
                getSENDER() + "', '" +
                getMESSAGE() + "', '" +
                getRECIPIENT() + "', '" +
    ...
    public ArrayList<String> retrieveSMSByPromoCode(String promoCode) {
        ...
        String selectQuerySMS = "SELECT * FROM tbl_sms " +
    ...
    public ArrayList<String> retrieveSMSSentBySystem() {
        String selectQueryPromo = "SELECT shortCode FROM tbl_promo;";
        ArrayList<String> shortCode = Database.retrievePromoList(selectQueryPromo);
        StringBuilder selectQuerySMS = new StringBuilder("SELECT * FROM tbl_sms " +
                "WHERE sender IN (");
    ...
    public ArrayList<String> retrieveSMSBySeveralMsisdn(String... msisdn) {
        StringBuilder selectQuery = new StringBuilder("SELECT * FROM tbl_sms " +
                "WHERE sender IN (");
